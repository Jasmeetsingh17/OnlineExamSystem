...
import com.lti.app.service.TopicService;
...
public class ExamController {
	...
	@GetMapping("/getQuestions/{tlevel}/{tid}")
	public List<Questions> getQuestions(@PathVariable(name = "tlevel") String tlevel,
			@PathVariable(name = "tid") String tid) {

		return eService.getQuestions(tlevel, tid);
	}
	...
	public Users searchUsers(@PathVariable(name = "userid") int userid) {
	...
	@GetMapping("/searchstudents/{city}/{tname}/{state}/{marks}")
	public List<Users> SearchStudents(@PathVariable(name = "city") String city,
			@PathVariable(name = "tname") String tname, @PathVariable(name = "state") String state,
			@PathVariable(name = "marks") int marks) {
		return sService.SearchStudents(city, tname, state, marks);
	}
	...
	public boolean triggerMail(@PathVariable(name = "userid") int uniqid) {
